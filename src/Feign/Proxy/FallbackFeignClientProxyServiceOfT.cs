...
{
    public abstract class FallbackFeignClientProxyService<TService, TFallback> : FallbackFeignClientProxyService, IFallbackFeignClient<TService>, IFeignClient<TService>
